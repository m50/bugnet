                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('tags') }}" class="form-control @error('title') is-invalid @enderror" name="tags" type="text" placeholder="Project Tags" id="tags" aria-describedby="nameHelp">
