                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('projects.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly value="{{ $project->name }}" required class="form-control @error('title') is-invalid @enderror" name="name" type="text" placeholder="Project Name" id="name" aria-describedby="nameHelp">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="2" class="form-control @error('title') is-invalid @enderror" name="description" type="text" placeholder="Project Description" id="description" aria-describedby="descriptionHelp">{{ old('description') ?? $project->description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('url') ?? $project->url }}" class="form-control @error('title') is-invalid @enderror" name="url" type="text" placeholder="Project URL" id="url" aria-describedby="urlHelp">
